...
<body>
        ...
        <div class="menu">
            <nav>
                <ul>
                    ...
                    <p><a href="#myteam" style="font-size: 15px; margin-left: 5px;">My Team</a></p>
                    <p><a href="registrasi.php" style="font-size: 15px; margin-left: 5px;">Registrasi</a></p>
                </ul>
            </nav>
        </div>
    </div>
    <div id="home-main">
        ...
        <div id="mywork">
            ...
            <div class="container-Work">
                <p><a href="tambahFoto.php" style="color: white; margin-left: 35px;">Tambah Foto</a>
                </p>
                <br>
                <div class="galery">
                    <?php
    ...
    <div class="myteam" id="myteam">
        ...
        <div class="judul-halaman">My Team<a href="tambahTeam.php" style="color: blue; font-style: italic;">+</a></div>
    ...
    <div id="contact-me">
        ...
        <div id="container-contact">
            ...
            <form action="sendEmail.php" class="admin" method="POST" enctype="multipart/form-data">
                <h5 class="name">Full Name:</h5>
                <input type="text" name="nama">
                <h5 class="email">Email :</h5>
                <input type="email" name="userEmail">
                <h5 class="messages"> Messages : </h5>
                <textarea name="message" id="text-area"></textarea><br>
                <input class="submit" type="submit" name="sendEmail" style="display: inline-block;" class="submit"
